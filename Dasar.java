...
public class Dasar {
    public static void main(String[] args) {
        ...
        int harga=0, option, lama, haMa, hari, bulan, tahun, counter = 0, user = -2, word = -1, pilihKamar;
        double haTot, haDis;
        float disc = 0.0f;
        ...
        String jenisKamar[] = { "Single Bed", "Double Bed", "Queens Bed", "Kings Bed" };
        int[][] hargaKamar = {
            { 100000, 300000, 400000, 600000 }, // Harga kamar di hotel Aria
            { 150000, 400000, 550000, 800000 }  // Harga kamar di hotel Montana
        };
            ...
            switch (option) {
                case 1:
                    ...
                    for (int i = 0; i < jenisKamar.length; i++) {
                        System.out.println((i + 1) + " " + jenisKamar[i]);
                    }
                    pilihKamar = scanner.nextInt();
                    harga = hargaKamar[0][pilihKamar - 1];
                    ...
                    if (cetakData == 'Y' || cetakData == 'y') {
                        ...
                        System.out.println("Jenis Kamar\t: " + jenisKamar[pilihKamar - 1]);
